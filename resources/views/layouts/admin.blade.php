...
<div class="wrapper ">
    <div class="sidebar" data-color="green" data-background-color="black" data-image="{{asset('img/sidebar-3.jpg')}}">
        <!--
            ...
            <ul class="nav">
                <div class="card card-profile mt-5 pt-2">
                    <div class="card-avatar">
                        ...
                        <img class="img" src="{{asset('/images/pic.jpg')}}" alt="https://placehold.it/400x400"/>
                        ...
                        <li class=" nav-item ">
                            <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false"
                               class="dropdown-toggle nav-link">
                                <i class="material-icons">bubble_chart</i>Medicines</a>
                            <ul class="collapse list-unstyled" id="homeSubmenu">
                                <li>
                                    <a class="nav-link ml-5" href="{{route('medicine.index')}}">All Medicines</a>
                                </li>
                                <li>
                                    <a class="nav-link ml-5" href="{{route('medicine.create')}}">Add Medicines</a>
                                </li>
                ...
                <div class="collapse navbar-collapse justify-content-end">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item mr-2">
                            <a class="nav-link p-0 m-0" href="{{url('cart/index')}}">
                            ...
                            <li class="nav-item dropdown mr-5">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ url('/logout') }}"><i class="fa fa-btn fa-sign-out"
                                                                          style="padding-left: 1rem"></i>Logout</a></li>
                                </ul>
