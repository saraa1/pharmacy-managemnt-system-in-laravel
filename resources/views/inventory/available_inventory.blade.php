        ...
        <div class="card">
            <div class="card-body table-responsive">
                <table class="table table-hover">
                    ...
                    <th class="text-warning">Total Quantity </th>
                    <th class="text-warning">Available Quantity</th>
                    ...
                    @foreach($inventory as $key=> $inven)
                        ...
                        <tr>
                            ...
                            <td>{{$inven->medicine->quantity}}</td>
                            <td>{{$inven->available_quantity}}</td>



                            <td>
                                <div class="form-group form-inline">
                                    <button class="bg-transparent border-dark"><a href="{{route('inventory.show',$inven->id)}}"><i class="fa fa-eye text-primary"></i></a></button>
                                    <button class="bg-transparent border-dark"><a href="{{route('inventory.edit',$inven->id)}}"><i class="fa fa-edit text-success"></i></a></button>
